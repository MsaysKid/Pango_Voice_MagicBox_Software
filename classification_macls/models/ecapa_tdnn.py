...
from classification_macls.models.pooling import AttentiveStatsPool, TemporalAveragePooling
from classification_macls.models.pooling import SelfAttentivePooling, TemporalStatisticsPooling
