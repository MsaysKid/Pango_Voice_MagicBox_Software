...
from classification_macls.data_utils.audio import AudioSegment
...
from classification_macls.utils.utils import dict_to_object, print_arguments
...
class MAClsPredictor:
    def __init__(self,
                 configs,
                 model_path='classification_models/EcapaTdnn_Fbank/best_model/',
                 use_gpu=True):
        """
        声音分类预测工具
        :param configs: 配置参数
