...
from classification_macls import SUPPORT_MODEL, __version__
from classification_macls.data_utils.collate_fn import collate_fn
from classification_macls.data_utils.featurizer import AudioFeaturizer
...
from classification_macls.metric.metrics import accuracy
from classification_macls.models.campplus import CAMPPlus
from classification_macls.models.ecapa_tdnn import EcapaTdnn
from classification_macls.models.eres2net import ERes2NetV2, ERes2Net
from classification_macls.models.panns import PANNS_CNN6, PANNS_CNN10, PANNS_CNN14
from classification_macls.models.res2net import Res2Net
from classification_macls.models.resnet_se import ResNetSE
from classification_macls.models.tdnn import TDNN
from classification_macls.utils.logger import setup_logger
from classification_macls.utils.scheduler import WarmupCosineSchedulerLR
from classification_macls.utils.utils import dict_to_object, plot_confusion_matrix, print_arguments
...
class MAClsTrainer(object):
    ...
    def extract_features(self, save_dir='classification_dataset/features'):
        """ 提取特征保存文件
    ...
    def train(self,
              save_model_path='classification_models/',
              resume_model=None,
    ...
    def export(self, save_model_path='classification_models/', resume_model='classification_models/EcapaTdnn_Fbank/best_model/'):
        """
        导出预测模型
        :param save_model_path: 模型保存的路径
